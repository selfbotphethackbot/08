...
selff = "u00f827ce6641038d7c9b6704a9777dfa"
...
#================================================
            ...
            elif "สิริ:" in msg.text:
                say = msg.text.replace("สิริ:","")
                lang = 'th'
                tts = gTTS(text=say, lang=lang)
                tts.save("hasil.mp3")
                cl.sendAudio(msg.to,"hasil.mp3")
...
#===============================================
            elif msg.text in ["Notifed on","เปิดเเจ้งเตือน","M on"]:
              if msg.from_ in admin:
                if wait["Notifed"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"All Notifed On\nเปิดการเเจ้งเตือนของคุณเเล้ว")
                    else:
                        cl.sendText(msg.to,"Done\nเปิดการเเจ้งเตือนของคุณเเล้ว")
                else:
                    wait["Notifed"] = True
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Done\nเปิดการเเจ้งเตือนของคุณเเล้ว")
            elif msg.text in ["Notifed off","ปิดเเจ้งเตือน","M off"]:
              if msg.from_ in admin:
                if wait["Notifed"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"All Notifed Off\nปิดการเเจ้งเตือนของคุณเเล้ว")
                    else:
                        cl.sendText(msg.to,"Done\nปิดการเเจ้งเตือนของคุณเเล้ว")
                else:
                    wait["Notifed"] = False
              ...
              if msg.from_ in admin:
                if wait["Notifedbot"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Done\nเปิดการเเจ้งเตือนบอทเเล้ว")
            elif msg.text in ["Notifedbot off","ปิดเเจ้งเตือนบอท","Mbot off"]:
              if msg.from_ in admin:
                if wait["Notifedbot"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"All bot Notifed Off\nปิดการเเจ้งเตือนบอทเเล้ว")
                    else:
                        cl.sendText(msg.to,"Done\nปิดการเเจ้งเตือนบอทเเล้ว")
                else:
...
#-----------------------------------------------------------
                ...
                try:
                    ...
                    amid = msg.text.replace("contactmd’","")
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    cl.sendText(msg.to,"ยกเลิกการเลียนเเบบ")
                                    break
                    elif cmd == "list":
                        if mimic["target"] == {}:
                            cl.sendText(msg.to,"No target")
            ...
            try:
                if op.param1 in wait2['readPoint']:
                    ...
                    if Nama in wait2['readMember'][op.param1]:
                        ...
                        wait2['readMember'][op.param1] += "\n╠ " + Nama + datetime.today().strftime('%H:%M')
