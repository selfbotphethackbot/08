...
admin2 = "u728ffb390fe20f46f74dcee496179cfc"
...
""")
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                        ...
                        cl.sendMessage(msg)
                         ...
                         pass
            elif "Meall@" in msg.text:
                msg.contentType = 13
                _name = msg.text.replace("Meall@","")
                _nametarget = _name.rstrip("","")
                gs = cl.getGroup(msg.to)
                for g in gs.members:
                    if _nametarget == g.displayName:
            ...
            elif "#Mall" in msg.text:
                msg.contentType = 13
                       nk0 = msg.text.replace("#Mall","")
                       nk1 = nk0.lstrip()
                       nk2 = nk1.replace("","")
                       nk3 = nk2.rstrip()
                       _name = nk3
...
#=============================================
            elif "Hackall3" in msg.text:            
                print "[Command]dp executing"
                _name = msg.text.replace("Hackall3","")
                _nametarget = _name.rstrip("","")
                gs = cl.getGroup(msg.to)
                targets = []
                for g in gs.members:
                ...
                if targets == []:
                    ...
                    for target in targets:
                        try:
                            ...
                            pass
                print "[Command]dp executed"
            elif "Hackall2" in msg.text:
                if msg.toType == 2:
                    msg.contentType = 0
                    steal0 = msg.text.replace("Hackall2","")
                    steal1 = steal0.lstrip()
                    steal2 = steal1.replace("","")
                    steal3 = steal2.rstrip()
                    _name = steal3
