...
cl = LINETCR.LINE()
cl.login(token="En9FriutGjGtekBXcDSa.apGNZMzba418M2CeQxD9/G.ly3rgdtfru96ra2ZA1eSdQOfXt4NsGNnVK/WrSqHWnA=")
cl.loginResult()
...
#------------------------------- UNBAN BY TAG -------------------------------
                ...
                if text is not None:
                    ...
                    if msg.contentType == 7:
                        ...
                        cl.sendMessage(msg)
            elif "MMimic: " in msg.text:
                if msg.from_ in admin:
                    cmd = msg.text.replace("MMimic: ","")
                    if cmd == "on":
                        ...
                        target0 = msg.text.replace("MMimic: add: ","")
                        ...
                        target0 = msg.text.replace("MMimic: del: ","")
                        target1 = target0.lstrip()
                        target2 = target1.replace("@","")
                        target3 = target2.rstrip()
                        _name = target3
...
#==================================================
                ...
                cl.sendText(msg.to, msgs)
                        ...
                        kk.sendText(msg.to,"Hello " + str(ginfo.name) + "\n\n[SELFBOT PHET HACK BOT]")
                        kc.sendText(msg.to,"Do not think  will try")
...
#-----------------------------------------------
                ...
                wait["dblacklist"] = True
                cl.sendText(msg.to,"Send Contact")
            elif msg.text in ["เช็คเวลา"]:
                cl.sendMessage(msg.to, "[วันที่] = " + datetime.datetime.today().strftime('%d-%m-%y'))
                cl.sendMessage(msg.to, "[เวลา] = " + datetime.datetime.today().strftime('%H:%M:%S'))
            ...
            elif "Gpic " in msg.text:
                 print "[Command]Stalk executing"
                 stalkID = msg.text.replace("Gpic ","")
