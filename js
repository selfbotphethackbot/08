...
kg = LINETCR.LINE()
kg.login(token="Em5t4Qvnp2QI04waO3H1.jt1oAwM8iM3IBVGZhNqoqq.f2i519RYvBvEUAMmSDiJb6dYJ3nO7pbX5exkrHKJ2X0=")
kg.loginResult()
...
kp = LINETCR.LINE()
kp.login(token="EnY9UMZkEeR8dEJ2TEO2.u7dXtFE2om6+abuezxf10G.XuDyz+8pkowo0xxlqZBB7h7M6CTbyrghfcAtbZIBb3c=")
kp.loginResult()

kq = LINETCR.LINE()
kq.login(token="EnjCBf4vbQEMF3AZSpf5.4VV75lIJEeztkjy6p+LB1q.3BkLh4HgT4fPeMakPCvr5xnKagiEceCoy8LqPeSoEYg=")
kq.loginResult()

kr = LINETCR.LINE()
kr.login(token="EnAF3aNWmuwxzQ73k0Lc.NlPtoq0xpjoHMiBeMmE4ta.55OQ2bGEc/RXAoFznd6LfOifU1aEEzLi77fh7bQ7imc=")
kr.loginResult()
...
kt1 = LINETCR.LINE()
kt1.login(token="EnARXjtylxkQLaARoxX3.tnLt9e21SFZhUJ1+j3WMiW.CO/qZDhk/kaALmQbr+dvK6ttWW/qfBiTAkX4t5QuPQA=")
kt1.loginResult()

kt2 = LINETCR.LINE()
kt2.login(token="EncLusEhIYLq8c51upy0.igIynfvMhN1T0yXE1EfZWa.sh535OHLOOJdmdGslq+xFJW01YvtLOg9AUdDKafXCm0=")
kt2.loginResult()

kt3 = LINETCR.LINE()
kt3.login(token="En3oenRpXHFn9SSI45d3.qoUck3O8nMbB0hQWUC9FuW.4L8O2B7MUQHEbi6oPn5mpvFimiTl3DenGA25Qdz18Bg=")
kt3.loginResult()

kt4 = LINETCR.LINE()
kt4.login(token="EnVRKtEsfvL8XskDGlG7.ze8OyYKKLr+hFVtYXEpqPW.C8cj3LkQR/9pWJTRSRzel7HONHU3wt1M8ZpkqDFd4tI=")
kt4.loginResult()

kt5 = LINETCR.LINE()
kt5.login(token="EnpamO5ezfrbLKbO2tz2.7tfjVIkVm8PQoSJIZIWKGG.I5zufwiFZw3+8gVJzRu1xklVuuAsWrwkwxi7vK11r+E=")
kt5.loginResult()

kt6 = LINETCR.LINE()
kt6.login(token="EnE26rv1ozKF3S4rgtz7.53r8qV6xwvNbCfWBNyAevW.zGIQ1/LFGNdTiblP3Gsr/bGGov5bpx+VDwPDe2WNvZI=")
kt6.loginResult()

kt7 = LINETCR.LINE()
kt7.login(token="EnJhrSUDRybl3nYXaPka.ZZHUjOJdZ+T6DpfqV9hbcG.QHgueFxRkSkbl2NOZT6inHkJPQNvopoKCi+YglozPuo=")
kt7.loginResult()

kt8 = LINETCR.LINE()
kt8.login(token="EnSHoQDh9m48bxwPgui2.sfpct6ifkLrftJQHfmDiWG.i9T9V9qvxNiXhJ3qywOgLYeNj8XTFxBZ2zK0ANUqS5A=")
kt8.loginResult()

kt9 = LINETCR.LINE()
kt9.login(token="En35R6b5auaWnLDgn8R7.LcFAfKHkMjFks6Gn1rIbfW.55gjKTQLTZ6B9BX++hjd1x2qnR51s9xdSlmeU7VdZ7o=")
kt9.loginResult()

kt10 = LINETCR.LINE()
kt10.login(token="EnrvDjKEc2X9ptabWjb9.pYS8slD2SFe73cHzFPF2Yq.vnCRt3Hz/VwMZF/a1FiaeH36XU/taI+3szE4OFbM15g=")
kt10.loginResult()

kt11 = LINETCR.LINE()
kt11.login(token="En6cwZcPswLLTzVGrnXe.sIZ8RnoNwjp+9jc/NnVkRG.wk6Mu9vMPCB4V9GDWfdFrf0XXDVOGyPjcCfpQInyEi0=")
kt11.loginResult()

kt12 = LINETCR.LINE()
kt12.login(token="EnDNcXJlUUtQ9X3V5jq0.n5kWDXFC8XI7Dbn3INM9ya.eK7+oaRFE3Vq7xxA+zyUJwimsk93F0SsIpVJuOaCefA=")
kt12.loginResult()

kt13 = LINETCR.LINE()
kt13.login(token="EnTurSGyb28n05CAzbH6.tILoflUF0f128giOCNqLnG.scCadCxQ0tJvSrX7CmE4REbD4/fkpg0baISs3qgCXXM=")
kt13.loginResult()

kt14 = LINETCR.LINE()
kt14.login(token="EnIdUaCFcDMSluEhpHw4.Rxb1+dPTNNJXyPuMVv15ra.ZF8rX/QM/bUy6BycUvR6X5xvUgpCEDWtvRbUCbrabO4=")
kt14.loginResult()

kt15 = LINETCR.LINE()
kt15.login(token="EnDs6hPGZBqtkepspLka.E0zcHCucfIzU9SWmCf1HkG.CbrTFEQHOyQLBJeyy4FhZp4ve7Z2P+JJFJ5bV8BExGY=")
kt15.loginResult()
...
KAC=[cl,ki,kk,kc,kd,ke,kf,kg,kh,kj,kl,km,kn,ko,kp,kq,kr,ks,kt,kt1,kt2,kt3,kt4,kt5,kt6,kt7,kt8,kt9,kt10,kt11,kt12,kt13,kt14,kt15]
...
Tmid1 = kt1.getProfile().mid
Tmid2 = kt2.getProfile().mid
Tmid3 = kt3.getProfile().mid
Tmid4 = kt4.getProfile().mid
Tmid5 = kt5.getProfile().mid
Tmid6 = kt6.getProfile().mid
Tmid7 = kt7.getProfile().mid
Tmid8 = kt8.getProfile().mid
Tmid9 = kt9.getProfile().mid
Tmid10 = kt10.getProfile().mid
Tmid11 = kt11.getProfile().mid
Tmid12 = kt12.getProfile().mid
Tmid13 = kt13.getProfile().mid
Tmid14 = kt14.getProfile().mid
Tmid15 = kt15.getProfile().mid
protectname = []
protecturl = []
protection = []
autocancel = {}
...
Bots = ["u00f827ce6641038d7c9b6704a9777dfa",mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid,Tmid1,Tmid2,Tmid3,Tmid4,Tmid5,Tmid6,Tmid7,Tmid8,Tmid9,Tmid10,Tmid11,Tmid12,Tmid13,Tmid14,Tmid15]
self = ["u00f827ce6641038d7c9b6704a9777dfa",mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid,Tmid1,Tmid2,Tmid3,Tmid4,Tmid5,Tmid6,Tmid7,Tmid8,Tmid9,Tmid10,Tmid11,Tmid12,Tmid13,Tmid14,Tmid15]
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                cl.sendMessage(msg)
                msg.contentMetadata = {'mid': Tmid1}
                cl.sendMessage(msg)
                msg.contentMetadata = {'mid': Tmid2}
                cl.sendMessage(msg)
                msg.contentMetadata = {'mid': Tmid3}
                cl.sendMessage(msg)
                msg.contentMetadata = {'mid': Tmid4}
                cl.sendMessage(msg)
                msg.contentMetadata = {'mid': Tmid5}
                cl.sendMessage(msg)
                msg.contentMetadata = {'mid': Tmid6}
                cl.sendMessage(msg)
                msg.contentMetadata = {'mid': Tmid7}
                cl.sendMessage(msg)
                msg.contentMetadata = {'mid': Tmid8}
                cl.sendMessage(msg)
                msg.contentMetadata = {'mid': Tmid9}
                cl.sendMessage(msg)
                msg.contentMetadata = {'mid': Tmid10}
                cl.sendMessage(msg)
                msg.contentMetadata = {'mid': Tmid11}
                cl.sendMessage(msg)
                msg.contentMetadata = {'mid': Tmid12}
                cl.sendMessage(msg)
                msg.contentMetadata = {'mid': Tmid13}
                cl.sendMessage(msg)
                msg.contentMetadata = {'mid': Tmid14}
...
#----------------------------------------------------------------------------
                ...
                kt8.sendMessage(msg)
                kt9.sendMessage(msg)
                kt10.sendMessage(msg)
                kt11.sendMessage(msg)
                kt12.sendMessage(msg)
                kt13.sendMessage(msg)
                kt14.sendMessage(msg)
            elif msg.text in ["Gift Run"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '12'}
...
#==================================================
                ...
                cl.sendText(msg.to, msgs)
                        ...
                        kt1.acceptGroupInvitationByTicket(msg.to,Ticket)
                        kt2.acceptGroupInvitationByTicket(msg.to,Ticket)
                        kt3.acceptGroupInvitationByTicket(msg.to,Ticket)
                        kt4.acceptGroupInvitationByTicket(msg.to,Ticket)
                        kt5.acceptGroupInvitationByTicket(msg.to,Ticket)
                        kt6.acceptGroupInvitationByTicket(msg.to,Ticket)
                        kt7.acceptGroupInvitationByTicket(msg.to,Ticket)
                        kt8.acceptGroupInvitationByTicket(msg.to,Ticket)
                        kt9.acceptGroupInvitationByTicket(msg.to,Ticket)
                        kt10.acceptGroupInvitationByTicket(msg.to,Ticket)
                        kt11.acceptGroupInvitationByTicket(msg.to,Ticket)
                        kt12.acceptGroupInvitationByTicket(msg.to,Ticket)
                        kt13.acceptGroupInvitationByTicket(msg.to,Ticket)
                        kt14.acceptGroupInvitationByTicket(msg.to,Ticket)
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        kl.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kl.leaveGroup(msg.to)
                        km.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        km.leaveGroup(msg.to)
                        kn.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kn.leaveGroup(msg.to)
                        ko.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        ko.leaveGroup(msg.to)
                        kp.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kp.leaveGroup(msg.to)
                        kq.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kq.leaveGroup(msg.to)
                        kr.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kr.leaveGroup(msg.to)
                        ks.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        ks.leaveGroup(msg.to)
                        kt.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kt.leaveGroup(msg.to)
                        kt1.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kt1.leaveGroup(msg.to)
                        kt2.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kt2.leaveGroup(msg.to)
                        kt3.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kt3.leaveGroup(msg.to)
                        kt4.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kt4.leaveGroup(msg.to)
                        kt5.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kt5.leaveGroup(msg.to)
                        kt6.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kt6.leaveGroup(msg.to)
                        kt7.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kt7.leaveGroup(msg.to)
                        kt8.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kt8.leaveGroup(msg.to)
                        kt9.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kt9.leaveGroup(msg.to)
                        kt10.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kt10.leaveGroup(msg.to)
                        kt11.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kt11.leaveGroup(msg.to)
                        kt12.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kt12.leaveGroup(msg.to)
                        kt13.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kt13.leaveGroup(msg.to)
                        kt14.sendText(msg.to,"Bye~Bye 􀜁􀄯􏿿"  +  str(ginfo.name)  + "\n\n[By.เพชร ทีมมดลองบอท]")
                        kt14.leaveGroup(msg.to)
...
#==================================================
		...
		#	cl.sendText(msg.to,mid)
			...
			kt.sendText(msg.to,Tmid)
                        kt1.sendText(msg.to,Tmid1)
                        kt2.sendText(msg.to,Tmid2)
                        kt3.sendText(msg.to,Tmid3)
                        kt4.sendText(msg.to,Tmid4)
                        kt5.sendText(msg.to,Tmid5)
                        kt6.sendText(msg.to,Tmid6)
                        kt7.sendText(msg.to,Tmid7)
                        kt8.sendText(msg.to,Tmid8)
                        kt9.sendText(msg.to,Tmid9)
                        kt10.sendText(msg.to,Tmid10)
                        kt11.sendText(msg.to,Tmid11)
                        kt12.sendText(msg.to,Tmid12)
                        kt13.sendText(msg.to,Tmid13)
                        kt14.sendText(msg.to,Tmid14)
                        ki.sendText(msg.to,"Hmm....")
...
""")
                ...
                kt1.sendText(msg.to,"Bot 19🔥")
                kt2.sendText(msg.to,"Bot 20🔥")
                kt3.sendText(msg.to,"Bot 21🔥")
                kt4.sendText(msg.to,"Bot 22🔥")
                kt5.sendText(msg.to,"Bot 23🔥")
                kt6.sendText(msg.to,"Bot 24🔥")
                kt7.sendText(msg.to,"Bot 25🔥")
                kt8.sendText(msg.to,"Bot 26🔥")
                kt9.sendText(msg.to,"Bot 27🔥")
                kt10.sendText(msg.to,"Bot 28🔥")
                kt11.sendText(msg.to,"Bot 29🔥")
                kt12.sendText(msg.to,"Bot 30🔥")
                kt13.sendText(msg.to,"Bot 31🔥")
                kt14.sendText(msg.to,"Bot 32🔥")
                                ...
                                kt1.sendText(msg.to,(bctxt))
                                kt2.sendText(msg.to,(bctxt))
                                kt3.sendText(msg.to,(bctxt))
                                kt4.sendText(msg.to,(bctxt))
                                kt5.sendText(msg.to,(bctxt))
                                kt6.sendText(msg.to,(bctxt))
                                kt7.sendText(msg.to,(bctxt))
                                kt8.sendText(msg.to,(bctxt))
                                kt9.sendText(msg.to,(bctxt))
                                kt10.sendText(msg.to,(bctxt))
                                kt11.sendText(msg.to,(bctxt))
                                kt12.sendText(msg.to,(bctxt))
                                kt13.sendText(msg.to,(bctxt))
                                kt14.sendText(msg.to,(bctxt))
...
#========================================
	    ...
	    elif msg.text in ["Mimic:on","mic:on"]:
                wait2["copy"] = True
                cl.sendText(msg.to,"copy on")
	    elif msg.text in ["Mimic:off","mic:off"]:
                wait2["copy"] = False
...
#===============================================
                ...
                kt1.sendText(msg.to, "%sseconds" % (elapsed_time))    
                kt2.sendText(msg.to, "%sseconds" % (elapsed_time))    
                kt3.sendText(msg.to, "%sseconds" % (elapsed_time))    
                kt4.sendText(msg.to, "%sseconds" % (elapsed_time))    
                kt5.sendText(msg.to, "%sseconds" % (elapsed_time))    
                kt6.sendText(msg.to, "%sseconds" % (elapsed_time))    
                kt7.sendText(msg.to, "%sseconds" % (elapsed_time))    
                kt8.sendText(msg.to, "%sseconds" % (elapsed_time))    
                kt9.sendText(msg.to, "%sseconds" % (elapsed_time))    
                kt10.sendText(msg.to, "%sseconds" % (elapsed_time))    
                kt11.sendText(msg.to, "%sseconds" % (elapsed_time))    
                kt12.sendText(msg.to, "%sseconds" % (elapsed_time))    
                kt13.sendText(msg.to, "%sseconds" % (elapsed_time))    
                kt14.sendText(msg.to, "%sseconds" % (elapsed_time))    
...
#========================================
                ...
                try:
                    ...
                    kt1.updateDisplayPicture(backup.pictureStatus)
                    kt1.updateProfile(backup)
                    kt2.updateDisplayPicture(backup.pictureStatus)
                    kt2.updateProfile(backup)
                    kt3.updateDisplayPicture(backup.pictureStatus)
                    kt3.updateProfile(backup)
                    kt4.updateDisplayPicture(backup.pictureStatus)
                    kt4.updateProfile(backup)
                    kt5.updateDisplayPicture(backup.pictureStatus)
                    kt5.updateProfile(backup)
                    kt6.updateDisplayPicture(backup.pictureStatus)
                    kt6.updateProfile(backup)
                    kt7.updateDisplayPicture(backup.pictureStatus)
                    kt7.updateProfile(backup)
                    kt8.updateDisplayPicture(backup.pictureStatus)
                    kt8.updateProfile(backup)
                    kt9.updateDisplayPicture(backup.pictureStatus)
                    kt9.updateProfile(backup)
                    kt10.updateDisplayPicture(backup.pictureStatus)
                    kt10.updateProfile(backup)
                    kt11.updateDisplayPicture(backup.pictureStatus)
                    kt11.updateProfile(backup)
                    kt12.updateDisplayPicture(backup.pictureStatus)
                    kt12.updateProfile(backup)
                    kt13.updateDisplayPicture(backup.pictureStatus)
                    kt13.updateProfile(backup)
                    kt14.updateDisplayPicture(backup.pictureStatus)
                    kt14.updateProfile(backup)
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    kt1.cloneContactProfile(target)
                                    kt2.cloneContactProfile(target)
                                    kt3.cloneContactProfile(target)
                                    kt4.cloneContactProfile(target)
                                    kt5.cloneContactProfile(target)
                                    kt6.cloneContactProfile(target)
                                    kt7.cloneContactProfile(target)
                                    kt8.cloneContactProfile(target)
                                    kt9.cloneContactProfile(target)
                                    kt10.cloneContactProfile(target)
                                    kt11.cloneContactProfile(target)
                                    kt12.cloneContactProfile(target)
                                    kt13.cloneContactProfile(target)
                                    kt14.cloneContactProfile(target)
...
#========================================
            ...
            elif msg.text in ["Pmic in"]:
                  X = cl.getGroup(msg.to)                    
                  X.preventJoinByTicket = False
                  cl.updateGroup(X)
                  invsend = 0 
                  Ti = cl.reissueGroupTicket(msg.to)
                  kt15.acceptGroupInvitationByTicket(msg.to,Ti)                 
                  G = kt15.getGroup(msg.to)
                  G.preventJoinByTicket = True
                  kt15.updateGroup(G)
                  print "Kicker2_Ok!"
                  Ticket = kt15.reissueGroupTicket(msg.to)
                ...
                try:
                     ...
                     pass
            elif msg.text in ["Pmic bye"]:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
                     kt15.leaveGroup(msg.to)
                except:
                     pass
...
# ----------------- BAN MEMBER BY TAG 2TAG ATAU 10TAG MEMBER
       ...
       #-------------Fungsi Respon Start---------------------#
                ...
                kt8.sendText(msg.to,"•••••••••••••••••••••••••")
                kt9.sendText(msg.to,"••••••••••••••••••••••••••")
                kt10.sendText(msg.to,"••••••••••••••••••••••••••")
                kt11.sendText(msg.to,"•••••••••••••••••••••••••••")
                kt12.sendText(msg.to,"••••••••••••••••••••••••••••")
                kt13.sendText(msg.to,"•••••••••••••••••••••••••••••")
                kt14.sendText(msg.to,"PHET HACK BOT Complete 100%")
...
#============================================
		 ...
		 if msg.toType == 2:
 		 ...
 		 if msg.toType == 2:
            ...
            elif msg.text in ["Invite Contact"]:
              if msg.from_ in admin:
                 wait["winvite"] = True
                 cl.sendText(msg.to,"send contact")

#----------------------------------------------------------
	    elif "mic on" in msg.text:
	    ...
	    elif "mic off " in msg.text and msg.text != helpMessage:
		no = msg.text.replace("mic off ","")
		midsTarget = []
...
#=================================List mimic status===================
        if op.type == 17:
            ...
            cb = Message()
            cb.to = op.param1
            cb.text = cl.getContact(op.param2).displayName + "\n 􀜁􀄯􏿿 ยินดีต้อนรับครับ  􀜁􀄯􏿿\n" + group.name
            cl.sendMessage(cb)
            cb.text = cl.getContact(op.param2).displayName + "\nอย่าลืมปิดเเจ้งเตือนด้วยนะจ่ะ\n\n[By. เพชร ทีมทดลองบอท]"
            cl.sendMessage(cb)
